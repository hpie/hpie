...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:DropDownList ID="month" runat="server" AutoPostBack="True" onselectedindexchanged="month_SelectedIndexChanged" 
        ...
        SelectCommand="SELECT * FROM [fc31] where dt&gt;=@dt and dt&lt;=@dt1" 
        DeleteCommand="delete from fc31 where Code=@Code" 
        UpdateCommand="update fc31 set dt=@dt,fm=@fm,t_o=@t_o,steam_coal=@steam_coal,fuel_wood=@fuel_wood,indent_number=@indent_number,rem=@rem where Code=@Code">
            <DeleteParameters>
        ...
        onrowediting="GridView1_RowEditing" style="font-size: 10pt" 
        onrowcancelingedit="GridView1_RowCancelingEdit" DataKeyNames="code" 
        ...
        onrowupdating="GridView1_RowUpdating">
            ...
            <Columns>
                <asp:TemplateField HeaderText="1">
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("dt","{0:dd/MM/yyyy}") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="fTextBox7" runat="server" 
                            Text='<%# Eval("dt","{0:dd/MM/yyyy}") %>' Width="80px"></asp:TextBox>
                        <ajaxToolkit:MaskedEditExtender ID="fTextBox7_MaskedEditExtender" 
                            runat="server" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" 
                            CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" 
                            CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" 
                            Mask="99/99/9999" MaskType="Date" TargetControlID="fTextBox7">
                        </ajaxToolkit:MaskedEditExtender>
                        <ajaxToolkit:CalendarExtender ID="fTextBox7_CalendarExtender" runat="server" 
                            Enabled="True" Format="dd/MM/yyyy" TargetControlID="fTextBox7">
                ...
                <asp:TemplateField HeaderText="2.1">
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("fm","{0:dd/MM/yyyy}") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="2.2">
                    <ItemTemplate>
                        <asp:Label ID="Label3" runat="server" 
                            Text='<%# Eval("t_o","{0:dd/MM/yyyy}") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
           ...
           />
            <cc1:MaskedEditExtender ID="time2_MaskedEditExtender" runat="server" 
                ...
                <asp:TemplateField HeaderText="4.1">
                    <ItemTemplate>
                        <asp:Label ID="Label5" runat="server" Text='<%# Eval("steam_coal") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="4.2">
                    <ItemTemplate>
                        <asp:Label ID="Label6" runat="server" Text='<%# Eval("fuel_wood") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="5">
                    <ItemTemplate>
                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("indent_number") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="7">
                    ...
                    <FooterTemplate>
                      ...
                      <ItemTemplate>
                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("rem") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
