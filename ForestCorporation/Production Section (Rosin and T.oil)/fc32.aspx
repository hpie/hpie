<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="fc32.aspx.cs" Inherits="fc31" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:DropDownList ID="month" runat="server" AutoPostBack="True" 
        ...
        SelectCommand="SELECT * FROM [fc32] where dt=@dt and shift=@shift or particulars='ss'">
            <InsertParameters>
