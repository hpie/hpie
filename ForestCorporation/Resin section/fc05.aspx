<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="fc05.aspx.cs" Inherits="fc05" Title="Untitled Page" %>
    ...
    onselectedindexchanged="GridView1_SelectedIndexChanged" ShowFooter="True">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="No. of tins/drum">
                <FooterTemplate>
                    <asp:Label ID="Label39" Text='<%#tt %>' runat="server" style="font-weight: 700" ></asp:Label>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Net weight with sakki">
                <FooterTemplate>
                    <asp:Label ID="Label40" runat="server" Text='<%#tw %>' style="font-weight: 700" ></asp:Label>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Requistion slip">
             ...
             <asp:TemplateField HeaderText="Issue To Other Unit">
<%--                <FooterTemplate>
                    <asp:Label ID="Label" runat="server" style="font-weight: 700" Text="<%#itt %>"></asp:Label>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="No. of tins/drum">
                <FooterTemplate>
                    <asp:Label ID="Label41" runat="server" style="font-weight: 700" Text="<%#itt %>"></asp:Label>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label30" runat="server"></asp:Label>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Net weight with sakki">
                <FooterTemplate>
                    <asp:Label ID="Label42" runat="server" style="font-weight: 700" Text="<%#itw %>"></asp:Label>
                </FooterTemplate>
                <ItemTemplate>
