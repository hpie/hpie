...
&nbsp;&nbsp;&nbsp;
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:himuda %>" 
        InsertCommand="INSERT INTO dbo.cpf(Name_Des, AC, During_Year, Recovery_o_adv, Date, Div, File_name, Arear, Shared) VALUES (@Name_Des, @AC, @During_Year, @Recovery_o_adv, @Date, @Div, @file_name, @Arear, @Shared)" 
        
         
         SelectCommand="SELECT * FROM [cpf] where date=@date and div=@div and file_name is not null">
        <SelectParameters>
