...
&nbsp;
    ...
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT hsd_lot_no, lot_no, stack, size_type, remarks,  sum(as_per_no) as_per_no, sum(as_per_vol) as as_per_vol FROM dbo.tally_sheet where mark_to_auction='true' and auction_date=@auction_date group by hsd_lot_no,lot_no, stack, size_type, remarks order by hsd_lot_no">
            <InsertParameters>
               ...
               <%-- <asp:TemplateField HeaderText="Challan No.">
                ...
                <asp:TemplateField HeaderText="Vol.">
                    <FooterTemplate>
                     ...
                     <ItemTemplate>
                        <asp:Label ID="vol" Text='<%#Eval("as_per_vol")%>' runat="server"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
...
--%>
               ...
               <%-- <asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Bid"></asp:TemplateField>
                <asp:TemplateField HeaderText="Name of the Party"></asp:TemplateField>
            </Columns>
