...
public partial class drop_items : System.Web.UI.Page
{
    ...
    {
        SqlDataSource_div.Insert();
        division_t.Focus();
        division_t.Text = "";
    }
    protected void division_d_SelectedIndexChanged(object sender, EventArgs e)
    {
        division_t.Text = division_d.SelectedItem.Text;
        division_t.Focus();
    }
    protected void kind_d_SelectedIndexChanged(object sender, EventArgs e)
    {
        kind_t.Text = kind_d.SelectedItem.Text;
        kind_t.Focus();
    }
    protected void LinkButton11_Click(object sender, EventArgs e)
    {
        SqlDataSource_kind.Insert();
        kind_t.Focus();
        kind_t.Text = "";
    }
    protected void LinkButton12_Click(object sender, EventArgs e)
    {
        DataView dv = (DataView)(SqlDataSource_factor.Select(DataSourceSelectArguments.Empty));
        if (dv != null)
        {
            if (dv.Table.Rows.Count == 0)
            {
                SqlDataSource_factor.Insert();
            ...
            else
            {
                ...
                factor_val.Text = "";
                factor_name.Focus();
                Label1.Text = "Factor Name Allready in your List..";
            }
