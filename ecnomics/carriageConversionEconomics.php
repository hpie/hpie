...
<?php 
  $count=0;
    if(count($transPortationDetail) > 0)
    {
		...
		<td>
		<a href='indexThickBox.php?page=transportationEntryEcoRSDDelete&markId=<?php echo $markDetailId;?>&id=<?php echo $rowId;	?>' >Delete </a>
		</td>	
	...
	if($fromRSD == 1)
	{
		...
		<table style="width: 40%">
			<tr>
				...
				<a href='indexThickBox.php?page=transportationEntryEcoRSD&progressId=<?php echo $progressId;?>&markId=<?php echo $markDetailId;?>' >
				Add More</a>
				</td>
			</tr>
		</table>
