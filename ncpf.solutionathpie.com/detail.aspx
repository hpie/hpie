<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="detail.aspx.cs" Inherits="detail" Title="Himuda CPF Subscription Details" %>
<%@ Register
 ...
 <div id="print">
   ...
   <center>
    ...
    <div id="subscriptionGrid">
     <asp:GridView ID="subscriptionGridView" runat="server" AutoGenerateColumns="false" HeaderStyle-BackColor="#7779AF" HeaderStyle-ForeColor="Black" OnRowDataBound="subscriptionGridView_RowDataBound"
