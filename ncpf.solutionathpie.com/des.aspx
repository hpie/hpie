<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="des.aspx.cs" Inherits="des" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td class="style6" colspan="2">
            Designation Detail<asp:ScriptManager ID="ScriptManager1" runat="server">
            </asp:ScriptManager>
                        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:ListBox ID="ListBox1" runat="server" AutoPostBack="True" 
                DataSourceID="SqlDataSource1" DataTextField="Des" DataValueField="ID" 
                onselectedindexchanged="ListBox1_SelectedIndexChanged" Width="123px">
            </asp:ListBox>
            </span></span></span>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:himuda %>" 
                DeleteCommand="DELETE FROM tbdes WHERE (ID = @ID)" 
                InsertCommand="INSERT INTO tbdes(Des) VALUES (@Des)" 
                SelectCommand="SELECT * FROM [tbdes]" 
                UpdateCommand="UPDATE tbdes SET Des = @des WHERE (ID = @ID)">
                <DeleteParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ConnectionString="<%$ ConnectionStrings:himuda %>" 
                SelectCommand="SELECT * FROM [tbdes] WHERE ([ID] = @ID)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="ListBox1" Name="ID" 
