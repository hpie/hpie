...
?></font></div></h1>
			  ...
			  margin-left: 50px;
				 ...
				 <form action="enumverify_sub.php" method="post">
				<?php
				if($auth==1){
				...
				echo "<table cellspacing=10><tr><td>Lot No.</td><td><font color=#770404>" . $_SESSION['lot'] ."/".$_SESSION['kapa']."(".$_SESSION['exten'].") </font></td><td></td></tr><tr><td>Range</td><td><font color=#770404>" . $_SESSION['range'] . "</font></td><td></td></tr><tr><td>Unit</td><td><font color=#770404>" . $_SESSION['unit'] . "</font></td><td></td></tr><tr><td>Type of Area</td><td><font color=#770404>" . $_SESSION['ta'] . "</font></td><td></td></tr><tr><td>Method of Extraction</td><td><font color=#770404>" . $_SESSION['ext'] ."</font></td><td></td></tr><tr><tr><td>Name of the RSD</td><td><font color=#770404>" . $_SESSION['rsd'] . "</font></td><td></td></tr><tr><td>Details of the Blazes</td><td></td></tr><tr><td>Name of the Forest</td><td>Number of the Tentative Blazes</td></tr>";
				$nblazes =array();
                ...
                echo "<tr><td>" . $ppl[$i] . "</td><td><font color=#770404>" . $nblazest[$i] . "</td></tr>";
				
				$ttl = $ttl + $nblazest[$i];
				}
				echo "<tr><td>Total</td><td><font color=#770404>" . $ttl . "</td></tr>";
