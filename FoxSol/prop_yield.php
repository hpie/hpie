	...
	<div id="content-wrap"><div id="content">		
		...
		<div id="main">		
			...
			<div class="post">
				...
				<h1><div style="float:left">Create Proposed Yield</div>
...
?></font></div></h1>
			 	<br>
				<form  method="post" enctype="multipart/form-data" name="form1" onsubmit="return check();" action="Proposed_Yield.php">
					<p>Select Year for which Proposed Yield  is to be generated <select name="year" >
	...
	<?php 
	 //TODO:Sunil $data = mysql_query("SELECT distinct division FROM enum") or die("No table"); 
