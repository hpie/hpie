...
<table>
<tr>
<td><input type="button" onclick="javascript:window.location.assign('client.php')" value="Back" /></td>
<td><input type="button" name="but" onclick="print()"value="Print this Monthly Report" /> </td>
</tr>
</table>
...
<table width="1000" border="1">
	...
	if($result89 !=0 && $result !=0)
	{
		...
		for($i=0; $i<$result; $i++)
		{
			$k=$i+1;
			$yra=$yr-1;
			//echo("<tr><td colspan='46'><b>Lot [ ".$lotno[$i]." ]     DFO ".$divi[$i]."</b></td></tr>");
			$dato1 = mysql_query("SELECT SUM(nblazes) As blazetotal FROM tap_store WHERE year='$yra' AND lotno='$lotno[$i]' AND division='$divi[$i]'");

			$dato12 = mysql_query("SELECT * FROM tap_store WHERE year='$yra' AND lotno='$lotno[$i]' AND division='$divi[$i]'");
			...
			$dato2 = mysql_query("SELECT SUM(blaze) As blazetotal FROM verify WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]'");
			$dato13 = mysql_query("SELECT * FROM verify WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]'");
			...
			if($mon==1)
			{
				$dato3 = mysql_query("SELECT SUM(nblazes) As blazetotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>='$mon'");
				$dato14 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>='$mon'");
			...
			$dato4 = mysql_query("SELECT * FROM yield_fixed WHERE Year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]'");
			...
			if($mon==1)
			{
				$dato5 = mysql_query("SELECT SUM(tin_collect) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>'$mon'");
				$dato501 = mysql_query("SELECT SUM(tin_collect_w) As tintotalw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>'$mon'");
				$dato6 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>'$mon'");
			}
			else
			{
				$dato5 = mysql_query("SELECT SUM(tin_collect) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth<'$mon'");
			...
			$dato502 = mysql_query("SELECT SUM(tin_collect) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato503 = mysql_query("SELECT SUM(tin_collect_w) As tintotalw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato504 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			...
			if($mon==1)
			{
				$dato7 = mysql_query("SELECT SUM(tin_carried) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>'$mon'");
				$dato510 = mysql_query("SELECT SUM(tin_carried_w) As tintotalw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>'$mon'");
				$dato8 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>'$mon'");
			...
			$dato511 = mysql_query("SELECT SUM(tin_carried) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato512 = mysql_query("SELECT SUM(tin_carried_w) As tintotalw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato513 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			...
			if($mon==1)
			{
				$dato9 = mysql_query("SELECT SUM(tin_dispatch) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>'$mon'");
				$dato601 = mysql_query("SELECT SUM(tin_dispatch_w) As tintotalw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>'$mon'");
				$dato10 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>'$mon'");
			}
			else
			{
				$dato9 = mysql_query("SELECT SUM(tin_dispatch) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth<'$mon'");
			...
			$dato701 = mysql_query("SELECT SUM(tin_dispatch) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato702 = mysql_query("SELECT SUM(tin_dispatch_w) As tintotalw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato703 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			...
			$dato801 = mysql_query("SELECT SUM(tin_dispatch_o) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato802 = mysql_query("SELECT SUM(tin_dispatch_o_w) As tintotalw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato803 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			...
			$dato301 = mysql_query("SELECT SUM(tin_lost_fi) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato302 = mysql_query("SELECT SUM(tin_lost_fi_w) As tintotalw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato303 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			...
			$dato304 = mysql_query("SELECT SUM(tin_lost_f) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato305 = mysql_query("SELECT SUM(tin_lost_f_w) As tintotalw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato306 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			...
			$dato307 = mysql_query("SELECT SUM(tin_lost_t) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato308 = mysql_query("SELECT SUM(tin_lost_t_w) As tintotalw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato309 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			...
			$dato310 = mysql_query("SELECT SUM(tin_lost_o) As tintotal FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato311 = mysql_query("SELECT SUM(tin_lost_o_w) As tintotalw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
			$dato312 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth='$mon'");
		 ...
		 if($mon==1)
		 {
		 	$dato10 = mysql_query("SELECT SUM(tin_collect_w) As tintotal FROM tap_store WHERE year='$yra' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>='$mon'");
		 	$dato11 = mysql_query("SELECT * FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth>='$mon'");
		 }
		 else
		 {
		 	$dato10 = mysql_query("SELECT SUM(tin_collect_w) As tintotal FROM tap_store WHERE year='$yra' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND tomonth<='$mon'");
		 ...
		 $extt = mysql_query("SELECT exten FROM lot_desc WHERE lotno='$lotno[$i]' AND division='$divi[$i]'");
		 $extr = mysql_num_rows($extt);
			...
			$maxid = mysql_query("SELECT MAX(id) AS idw FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND frmmonth='$mon'");
		 while($info111 = mysql_fetch_array( $maxid ))
		 {
		 	$maxoid=$info111['idw'];
		 	 
		 }
		 $mazd = mysql_query("SELECT nmazdoor, remark FROM tap_store WHERE year='$yr' AND lotno='$lotno[$i]' AND division='$divi[$i]' AND frmmonth='$mon' AND id='$maxoid'");
		 $maz = mysql_num_rows($mazd);
			...
			echo '<tr>
    <td>' . $k . '</td>
	<td>' . $lotno[$i] . '/' . $yr . '(' . getExten($lotno[$i],$divi[$i]). ')</td>
	<td>' . $sum2 . '</td>
	<td>' . $sum3 . '</td>
	<td>' . $sum4 . '</td>
	<td>' . $sum5 . '</td>
