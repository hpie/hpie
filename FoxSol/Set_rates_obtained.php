	...
	<div id="content-wrap"><div id="content">		
		...
		<div id="main">		
			...
			<div class="post">
				...
				<h1><div style="float:left">Rates Obtained/Fixed After Negotiotion Per Section</div>
...
?></font></div></h1>
			 	<br>
				<form  method="post" enctype="multipart/form-data" name="form1" onsubmit="return check();" action="enter_rateOb.php">
					<p>Select Year for which Rates Obtained is to be entered <select name="year" >
 ...
 <?php 
  $data = mysql_query("SELECT distinct division FROM lot_desc") or die("No table"); 
