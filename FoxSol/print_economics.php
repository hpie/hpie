...
<!-- wrap starts here -->
  ...
  <tr>
    <td colspan="5"><div align="center" class="style1"><span class="style4"><strong>HIMACHAL PRADESH STATE FOREST CORPORATION LIMITED</strong></span><input type="button" onclick="print()" value="Print" /><br />
