...
$qr="select * from upset_price where lotno='$lotno' and division='$divi' and year='$year' and id=(select max(id) from upset_price where lotno='$lotno' and division='$divi' and year='$year')";
...
<table border="1" align="center">
	...
	<tr>
		...
		<strong>ECONOMICS FOR RESIN LOT NO. <?php echo $lotno."/".$year."(".getExten($lotno,$divi).")" ; ?></strong></div>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td width="56">
		<div align="right"><span class="style5"><strong>2.</strong></span></div>
		</td>
		<td colspan="3">
		<div align="left"><span class="style3">Tentative No. of resin blazes </span></div>
		</td>
		<td width="108"><?php echo $tenblazes ; ?></td>
	</tr>
	<tr>
		<td width="56">
		<div align="right"><span class="style5"><strong>3.</strong></span></div>
		</td>
		<td colspan="3">
		<div align="left"><span class="style3">Number of Sections </span></div>
		</td>
		<td width="108"><?php echo round($tenblazes/1000 , 0) ; ?></td>
	</tr>
	<tr>
		<td>
		<div align="right"><span class="style5"><strong>4.</strong></span></div>
		</td>
		<td colspan="3">
		<div align="left"><span class="style3">Method of resin extraction </span></div>
		</td>
		<td><?php echo getMethEx($lotno,$divi);  ?></td>
	</tr>
	<tr>
		<td>
		<div align="right"><span class="style5"><strong>5.</strong></span></div>
		</td>
		<td colspan="3">
		<div align="left"><span class="style3">Yield fixed for <?php echo $curyear ; ?>
		resin season per Section(Qtls)</span></div>
		</td>
		<td><?php echo $yiefixed   ; ?></td>
	</tr>
	<tr>
		<td>
		<div align="right"><span class="style5"><strong>6.</strong></span></div>
		</td>
		<td colspan="3">
		<div align="left"><span class="style3">Name of RSDs </span></div>
		</td>
		<td><?php echo  getRSD($lotno,$divi) ; ?></td>
	</tr>
	<tr>
		<td>
		<div align="right"><span class="style5"><strong>7.</strong></span></div>
		</td>
		<td colspan="3">
		<div align="left"><span class="style3">Total quantity of resin likelly
		to be extracted as per yield fixed(Qtls) </span></div>
		</td>
		<td><?php echo  $totres  ; ?></td>
	</tr>
	<tr>
		<td>
		<div align="right"><span class="style5"><strong>8.</strong></span></div>
		</td>
		<td colspan="3">
		<div align="left"><span class="style3">Carriage of <?php echo $sess['emptinnum']; ?>
		Number of empty tins from RSD to Forest over distance <?php echo $sess['emptindis']; ?>
		KMs @ <?php echo $sess['emptinR']; ?> per 100 tins </span></div>
		</td>
	...
	<tr>
		<td>
		<div align="right"><span class="style5"><strong>9.</strong></span></div>
		</td>
		<td colspan="3">
		<div align="left"><span class="style3">Soldering of <?php echo $sess['emptinnum']; ?>
		Number of Resin Filled tins @ <?php echo $sess['emptinsolR']; ?> per
		tin </span></div>
		</td>
	...
	<tr>
		<td>
		<div align="right"><span class="style5"><strong>10.</strong></span></div>
		</td>
		<td><strong> Average distance from forest to RSD (as per lead
	...
	<tr>
		<td>
		<div align="right"><span class="style5"><strong>11. </strong></span></div>
		</td>
		<td colspan="2">
		<div align="left"><span class="style5"><strong>RESIN EXTRACTION
		CHARGES As Per SSR </strong></span></div>
		</td>
	...
	<tr>
		<td>
		<div align="right"><span class="style5"><strong>A.</strong></span></div>
		</td>
		<td colspan="2">
		<div align="left"><span class="style3">Crop setting charges per
		Section
	...
	<tr>
		<td>
		<div align="right"><span class="style5"><strong>B. </strong></span></div>
		</td>
		<td colspan="2">
		<div align="left"><span class="style3">Resin extraction charges per
		Qtls.</span></div>
		</td>
	...
	<tr>
		<td>
		<div align="right"><span class="style5"><strong>C.</strong></span></div>
		</td>
		<td colspan="2">
		<div align="left"><span class="style3">Add. Mate commission per Qtls
		if no. of majdoors are not less than 5(five) </span></div>
		</td>
	...
	<tr>
		<tr>
			<td>
			<div align="right"><span class="style5"><strong>D.</strong></span></div>
			</td>
			<td colspan="2">
			<div align="left"><span class="style3">Carriage of resin from forest
			to RSD by Mannual per km./ quintal </span></div>
			</td>
		...
		<tr>
			<tr>
				<td>
				<div align="right"><span class="style5"><strong>E.</strong></span></div>
				</td>
				<td colspan="2">
				<div align="left"><span class="style3">Cariage of resin by Mule per
				km/quintal </span></div>
				</td>
			...
			<tr>
				<td>
				<div align="right"><span class="style5"><strong>F.</strong></span></div>
				</td>
				<td colspan="2">
				<div align="left"><span class="style3">Cariage of resin by Tractor
				per km/quintal </span></div>
				</td>
			...
			<tr>
				<tr>
					<td>
					<div align="right"><span class="style5"><strong>G.</strong></span></div>
					</td>
					<td colspan="2">
					<div align="left"><span class="style3">Add element of tools and
					implements i.e., lips /pots etc. per quintal</span></div>
					</td>
				...
				<tr>
					<td>
					<div align="right"><span class="style5"><strong>H.</strong></span></div>
					</td>
					<td colspan="3">
					<div align="left"><span class="style3">Grand Total </span></div>
					</td>
					<td><?php  echo "$grandTotal" ; ?></td>
				</tr>
				<tr>
					<td>
					<div align="right"><span class="style5"><strong>I.</strong></span></div>
					</td>
					<td colspan="3">
					<div align="left"><span class="style3"><strong>Average rate per
					Qtls. </strong></span></div>
					</td>
					<td><strong><?php echo  "$avgrate" ; ?></strong></td>
				</tr>
				<tr>
					<td>
					<div align="right"><span class="style5"><strong>12. </strong></span></div>
					</td>
					<td colspan="2">
					<div align="left"><span class="style5"><strong>RESIN TRANSPORTATION
					CHARGES As Per SSR </strong></span></div>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3">
					<div align="left"><span class="style3">Loading Charges of <?php echo $sess['emptinnum']; ?>
					Number of resin filled tins over distance <?php echo $sess['distanceload']; echo "@ Rs.". $sess['lrate50']." upto 50 mtrs or Rs.". $sess['lrateb50']." beyond 50 upto 100 mtrs per 100 tins"; ?>
					</span></div>
					</td>
				...
				<tr>
					...
					<td colspan="3">
					<div align="left"><span class="style3">Transportation charges of <?php echo $sess['emptinnum']; ?>
					Number of resin filled tins from RSD to R & T for first 25 kms @ <?php echo $sess['trate25']; ?>
					</span></div>
					</td>
				...
				<tr>
					...
					<td colspan="3">
					<div align="left"><span class="style3">Transportation charges of <?php echo $sess['emptinnum']; ?>
					Number of resin filled tins from RSD to R & T beyond 25 kms @ <?php echo $sess['trateb25']; ?>
					per 1 Km </span></div>
					</td>
				...
				<tr>
					...
					<td colspan="3">
					<div align="left"><span class="style3">Total Transportation charges
					</span></div>
					</td>
				...
				<tr>
					...
					<td colspan="3">
					<div align="left"><span class="style3"><strong>Average
					Loading/Tranportation rate per Qtls. </strong></span></div>
					</td>
