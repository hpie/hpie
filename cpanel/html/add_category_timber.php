			...
			<td valign='top' align='center' colspan='2' class='tableHeader'><?=$Label;?></td>
				...
				<tr class='even'>
			     ...
			     <tr class='even'>
					...
					<td valign='top' align='left' width='80%'>
						<?=$db->makeSelectOptions($arrAllCategories,"i_category_id",$i_category_id);?>	
					</td>
				</tr>
			     ...
			     <tr class='even'>
					...
					<td valign='top' align='left' width='80%'><table>
					   <tr>
					    <?foreach($arrAllTimbers as $key=>$value){?>  
					     <td>
						 <table>
						  <tr>
						   <td>
						  ...
						  <tr>
						   <td align="center">
						   <input  style="width:50px" type="text" name="value[<?=$key?>]" id="value[<?=$key?>]" value="<?=$arrValues[$key];?>" onblur="outFocus(this)" onfocus="getFocus(this);"/>
						   </td>
                          </tr>
						  </table>
					     </td>
