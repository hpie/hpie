	...
	<form name ='add_page' id ='add_page'method ='POST' action ='' enctype='multipart/form-data'>
		<tr class='even'>
			<td valign='top' align='center' colspan='2' class='tableHeader'><?=$Label;?></td>
				...
				<?}?>
				<tr class='even'>
					<td valign='top' align='left' width='20%' class='label'>Forest Department</td>
				...
				<tr class='odd'>
					<td valign='top' align='left' width='20%' class='label'>Tree Type Name</td>
					<td valign='top' align='left' width='80%'><input type ='text' name='vc_name' value ='<?=$vc_name;?>'></td>
				</tr>
				
				<tr class='even'>
					<td valign='top' align='left' width='20%' class='label'>Default</td>
					<td valign='top' align='left' width='80%'>
						<?=$db->makeSelectOptions($arrDefault,"i_default",$i_default);?>	
					</td>
				</tr>
