...
<table width='100%' align='center' cellpadding='2' cellspacing='2' border='0'>
		<tr>
			...
			<tr class='titleBg'>
				<td align='center' colspan='8' class='title'>Forests Management&nbsp;:&nbsp;(<?=$totalRecords;?>)</td>
			</tr>
			<?
			...
			<tr class='title1Bg'>
				...
				<td class='title1' align='left'><a href="<?=BASE_URL.ADMIN_DIR;?>/forests.php?ob=department&o=<?=$dorderlink?>" title="Sort by department Name">Department Name</a></td>
				<td class='title1' align='left'><a href="<?=BASE_URL.ADMIN_DIR;?>/forests.php?ob=forest&o=<?=$forderlink?>" title="Sort by forest Name">Forest Name</a></td>
		...
		?>
			<tr class='normal' onmouseover="this.className='active'" onmouseout="this.className='normal'">
				...
				<td align='left' class='gridText'>&nbsp;<?=$d_name;?></td>
				<td align='left' class='gridText'>&nbsp;<?=$vc_name;?></td>
				
				<td><a  class='edit' title ='edit <?=$vc_name;?>' 
				href='add_forest.php?id=<?=$id;?>'>Edit</a>&nbsp|&nbsp;
				<a  class='delete' title ='delete <?=$vc_name;?>'onClick = 'deleteRecord("<?=$id;?>","<?=$vc_name;?>","forests")'>Delete</a></td>
