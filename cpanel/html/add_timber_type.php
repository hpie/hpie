			...
			<td valign='top' align='center' colspan='2' class='tableHeader'><?=$Label;?></td>
				...
				<tr class='even'>
					...
					<td valign='top' align='left' width='80%'>
						<?=$db->makeSelectOptions($arrTimber,"i_timber_id",$i_timber_id);?>	
					</td>
				</tr>
				
				<tr class='odd'>
					<td valign='top' align='left' width='20%' class='label'>Type Name</td>
					<td valign='top' align='left' width='80%'><input type ='text' name='vc_name' value ='<?=$vc_name;?>'></td>
				</tr>
				
				<tr class='odd'>
					<td valign='top' align='left' width='20%' class='label'>Type Volume</td>
					<td valign='top' align='left' width='80%'><input type ='text' name='volume' value ='<?=$volume;?>'></td>
				</tr>
				<tr class='even'>
					<td valign='top' align='left' width='20%' class='label'>Standard</td>
					<td valign='top' align='left' width='80%'>
						<?=$db->makeSelectOptions($arrStandard,"standard",$standard);?>	
					</td>
				</tr>
