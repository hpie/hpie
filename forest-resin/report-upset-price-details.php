			     ...
			     <?php
			     	if($action=="report")
			     	{
			     		...
			     		if(isset($reportData))
			     		{
			            	...
			            	{
				     			echo("<div class='divRow'> <span class='divCellLeft'>&nbsp;</span> <span class='divCellLeftBorder'>".$eow['forest_code']."</span> <span class='divCellLeftBorder'>".$eow['zone_code']."</span> <span class='divCellLeftBorder'>".$eow['zone_code']."</span> <span class='divCellRightBorder'>".$eow['blazes_received']."</span> </div>" );
			            	}
			            		...
			            		if($reportData['fwd']==1)
				     			{
				     				...
				     				}else 
				     				{
				     					...
				     					$eowArray['dist_carriage_mule_rsd']+=$eowCurrent['dist_carriage_mule_rsd'];
				     					...
				     					$eowArray['dist_carriage_manual_rsd']+=$eowCurrent['dist_carriage_manual_rsd'];
				     					...
				     					$eowArray['dist_carriage_tractor_rsd']+=$eowCurrent['dist_carriage_tractor_rsd'];
				     					...
				     					$eowArray['dist_carriage_other_rsd']+=$eowCurrent['dist_carriage_other_rsd'];
			            	...
			            	echo("<br />");
				     		...
				     		echo("<div class='divRow'> <span class='divCellLeft'>I)</span> <span class='divCellLeft'>Setting up of crop throught rill method on <b>".$eowArray['blazes_received']."</b> resin blazes @Rs. <b>".$eowArray['cost_crop_setting']."</b> per section </span> <span class='divCellRightBorder'>".$eowArray['exp_crop_setting']."</span> </div>" );
				     		...
				     		echo("<div class='divRow'> <span class='divCellLeft'>III)</span> <span class='divCellLeft'>Carriage of <b>".$eowArray['total_tins']."</b> No. of empty tins from RSD to Forest oever a distnace of <b>".$eowArray['distance_to_rsd']."</b> km @Rs. <b>".$eowArray['cost_tpt_tins_to_forest']."</b> per 100 tins </span> <span class='divCellRightBorder'>".$eowArray['exp_tpt_tins_to_forest']."</span> </div>" );
							...
							echo("<div class='divRow'> <span class='divCellLeft'>IX)</span> <span class='divCellLeft'>Mate comission @ Rs <b>".$eowArray['cost_mate_commission']."</b> per qtl fpr <b>".$eowArray['turnout']."</b> qtls extraced resin </span> <span class='divCellRightBorder'>".$eowArray['exp_mate_commission']."</span> </div>" );
			     			...
			     			foreach ($comData as $com )
			            	{
				     		...
				     		echo("<div class='divRow'> <span class='divCellLeft'>XVI)</span> <span class='divCellLeft'>Blower <b>".$comArray['qty_blower']."</b> kg. @Rs. <b>".$comArray['cost_blower']."</b> per kg </span> <span class='divCellRightBorder'>".$comArray['exp_blower']."</span> </div>" );
				     		echo("<div class='divRow'> <span class='divCellLeft'>XVII)</span> <span class='divCellLeft'>Solder Iron<b>".$comArray['qty_solder_iron']."</b> kg. @Rs. <b>".$comArray['cost_solder_iron']."</b> per kg </span> <span class='divCellRightBorder'>".$comArray['exp_solder_iron']."</span> </div>" );
				     		echo("<div class='divRow'> <span class='divCellLeft'>XVII)</span> <span class='divCellLeft'>Paint <b>".$comArray['qty_paint']."</b> kg. @Rs. <b>".$comArray['cost_paint']."</b> per kg </span> <span class='divCellRightBorder'>".$comArray['exp_paint']."</span> </div>" );
				     		echo("<div class='divRow'> <span class='divCellLeft'>XIX)</span> <span class='divCellLeft'>Cylinder 50ml <b>".$comArray['qty_cylinder_50ml']."</b> kg. @Rs. <b>".$comArray['cost_cylinder_50ml']."</b> per kg </span> <span class='divCellRightBorder'>".$comArray['exp_cylinder_50ml']."</span> </div>" );
				     		echo("<div class='divRow'> <span class='divCellLeft'>XX)</span> <span class='divCellLeft'>Cylinder 500ml <b>".$comArray['qty_cylinder_500ml']."</b> kg. @Rs. <b>".$comArray['cost_cylinder_500ml']."</b> per kg </span> <span class='divCellRightBorder'>".$comArray['exp_cylinder_500ml']."</span> </div>" );
				     		echo("<div class='divRow'> <span class='divCellLeft'>XXI)</span> <span class='divCellLeft'>Beaker 500ml <b>".$comArray['qty_beaker_500ml']."</b> kg. @Rs. <b>".$comArray['cost_beaker_500ml']."</b> per kg </span> <span class='divCellRightBorder'>".$comArray['exp_beaker_500ml']."</span> </div>" );
				     		echo("<div class='divRow'> <span class='divCellLeft'>XXII)</span> <span class='divCellLeft'>Beaker 1000ml <b>".$comArray['qty_beaker_1000ml']."</b> kg. @Rs. <b>".$comArray['cost_beaker_1000ml']."</b> per kg </span> <span class='divCellRightBorder'>".$comArray['exp_beaker_1000ml']."</span> </div>" );
				     		echo("<div class='divRow'> <span class='divCellLeft'>XXIII)</span> <span class='divCellLeft'>Funnel <b>".$comArray['qty_funnel']."</b> kg. @Rs. <b>".$comArray['cost_funnel']."</b> per kg </span> <span class='divCellRightBorder'>".$comArray['exp_funnel']."</span> </div>" );
				     		echo("<div class='divRow'> <span class='divCellLeft'>XXIV)</span> <span class='divCellLeft'>Other <b>".$comArray['qty_other']."</b> kg. @Rs. <b>".$comArray['cost_other']."</b> per kg </span> <span class='divCellRightBorder'>".$comArray['exp_other']."</span> </div>" );
