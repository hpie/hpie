...
namespace Disk_Cleaner.TaskScheduler.V2Interop
{
	...
	internal interface IRegisteredTask
	{
		...
		void GetRunTimes([In] ref Disk_Cleaner.TaskScheduler.V1Interop.SystemTime pstStart, [In] ref Disk_Cleaner.TaskScheduler.V1Interop.SystemTime pstEnd, [In, Out] ref uint pCount, [In, Out] ref IntPtr pRunTimes);
	}
