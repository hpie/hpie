...
namespace Disk_Cleaner.TaskScheduler
{
	#region Enumerations
	...
	*/
	...
	public class Task : IDisposable
	{
		...
		/*public Disk_Cleaner.TaskScheduler.InternalV2.IRunningTaskCollection GetInstances(int flags)
		{
			if (v2Task != null)
		...
		/// <remarks>The Little_Disk_Cleaner.TaskSchedulerEditor.dll assembly must reside in the same directory as the Little_Disk_Cleaner.TaskScheduler.dll or in the GAC.</remarks>
		public bool ShowEditor()
		{
			try
			{
                System.Reflection.Assembly asm = System.Reflection.Assembly.LoadFrom("Little_Disk_Cleaner.TaskSchedulerEditor.dll");
				if (asm != null)
				{
                    Type t = asm.GetType("Little_Disk_Cleaner.TaskScheduler.TaskEditDialog", false, false);
					if (t != null)
					{
