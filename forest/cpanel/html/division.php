...
<table width='100%' align='center' cellpadding='2' cellspacing='2' border='0'>
		<tr>
			...
			<tr class='titleBg'>
				<td align='center' colspan='8' class='title'>Division Management&nbsp;:&nbsp;(<?=$totalRecords;?>)</td>
			</tr>
			<?
			...
			<tr class='title1Bg'>
				...
				<td class='title1' align='left'>Division Name</td>
		...
		?>
			<tr class='normal' onmouseover="this.className='active'" onmouseout="this.className='normal'">
				...
				href='add_division.php?id=<?=$id;?>'>Edit</a>&nbsp|&nbsp;
				<a  class='delete' title ='delete <?=$vc_name;?>'onClick = 'deleteRecord("<?=$id;?>","<?=$vc_name;?>","division")'>Delete</a></td>
