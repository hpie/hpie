...
<table width='100%' align='center' cellpadding='2' cellspacing='2' border='0'>
		<tr>
			...
			<tr class='titleBg'>
				<td align='center' colspan='8' class='title'>Contractor Management&nbsp;:&nbsp;(<?=$totalRecords;?>)</td>
			</tr>
			<?
			...
			<tr class='title1Bg'>
				...
				<td class='title1' align='left'>Contractor Name</td>
		...
		foreach($arrUsers as $users){
			...
			$contractor_name		= $first_name.' '.$last_name;
		...
		?>
			<tr class='normal' onmouseover="this.className='active'" onmouseout="this.className='normal'">
				...
				<td align='left' class='gridText'>&nbsp;<?=$contractor_name;?></td>
				<td align='left' class='gridText'>&nbsp;<?=$email;?></td>
				<td align='left' class='gridText'>&nbsp;<?=$registered_on;?></td>
				<td><a  class='edit' title ='edit <?=$contractor_name;?>' 
				href='add_contractor.php?id=<?=$id;?>'>Edit</a>&nbsp|&nbsp;<a  class='delete' title ='delete <?=$contractor_name;?>'onClick = 'deleteRecord("<?=$id;?>","<?=$contractor_name;?>","contractor")'>Delete</a></td>
	...
	if(isset($_POST['statusSubmitted'])){
		$status = $_POST['status'];
		$db->isActive('contractor_detail',$status);
		ob_end_clean();
