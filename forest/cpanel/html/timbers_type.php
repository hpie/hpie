...
<table width='100%' align='center' cellpadding='2' cellspacing='2' border='0'>
		<tr>
			...
			<tr class='titleBg'>
				<td align='center' colspan='8' class='title'>Timbers Type Management&nbsp;:&nbsp;(<?=$totalRecords;?>)</td>
			</tr>
			<?
			...
			<tr class='title1Bg'>
				...
				<td class='title1' align='left'><a href="<?=BASE_URL.ADMIN_DIR;?>/timbers_type.php?ob=timber&o=<?=$torderlink?>" title="Sort by department id">Timber Name</a></td>
				<td class='title1' align='left'>Timber Type Name</td>
		...
		foreach($arrRecords as $records){
			...
			$i_timber_id        = $records['i_timber_id'];
			$timber_name        = $arrTimber[$i_timber_id]; 
		...
		?>
			<tr class='normal' onmouseover="this.className='active'" onmouseout="this.className='normal'">
				...
				<td align='left' class='gridText'>&nbsp;<?=$timber_name;?></td>
				<td align='left' class='gridText'>&nbsp;<?=$vc_name;?></td>
				
				<td><a  class='edit' title ='edit <?=$vc_name;?>' 
				href='add_timber_type.php?id=<?=$id;?>'>Edit</a>&nbsp|&nbsp;
				<a  class='delete' title ='delete <?=$vc_name;?>'onClick = 'deleteRecord("<?=$id;?>","<?=$vc_name;?>","timbers_type")'>Delete</a></td>
