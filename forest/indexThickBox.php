...
.fbProxyElement {
 ...
 <?php // if($_GET['page']=='markCompleteDetail' || $_GET['page']=='addOverhead'){?>
...
<div id='contractorDetail' style="z-index: 130;  position:absolute;background-color: gray;top: 200px; left: 100px">
</div>
...
if($_GET['page']=='addSellingPrice'){
		$currentPage='sellingPrice';
	     echo '<div id="content">';
		include('ecnomics/econimicsSellingPrice.php');
	}	
...
if($_GET['page']=='addScheduleRate'){
		$currentPage='scheduleRate';
		echo '<div id="content">';
		include('ecnomics/addScheduleRates.php');
	}
...
if($_GET['page']=='inventoryTimberLocation'){
	...
	if($_GET['page']=='transportationEntryEcnomicsRSD'){
		$currentPage='overheadEcoRSD';
		include('ecnomics/carriageConversionEconomics.php');
	}
	
	if($_GET['page']=='transportationEntryEcoRSD'){
		$currentPage='overheadEcoRSD';
		include('ecnomics/carriageConversionNewEconomics.php');
	}
	
	
	
	
	if($_GET['page']=='fellingChargesEco'){
	
		$currentPage='chargesEco';
		include('ecnomics/feelingChargesNew.php');
	}
	
	if($_GET['page']=='transportationEntryEcoDelete'){
	
		$currentPage='chargesEco';
		include('ecnomics/deleteConversion.php');
	}
	
	if($_GET['page']=='transportationEntryEcoRSDDelete'){
	
		$currentPage='chargesEco';
		include('ecnomics/delete.php');
	}
	
if($_GET['page']=='economicselector'){
	
		$currentPage='chargesEco';
		include('ecnomics/selecteconomic.php');
	}
