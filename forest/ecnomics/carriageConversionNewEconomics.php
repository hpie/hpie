...
if(isset($_POST['update'])){
	...
	$ecnomicsId=$existing['id'];	
		...
		foreach ($treeId as $index=>$value	)
		{
			...
			$id = $db->insert('ecnomics_transportation_detail_RSD',$c_tree_filling_detail);
		}
...
if (window.XMLHttpRequest)
  ...
  <?php 
		  ...
		  {
		  	?>
		  	var fileCall='ajax_call.php?get=volumefortransferEcoRSD&markId='+markDetailId+'&treeId='+treeId+'&pointId='+pointId+"&i_timber_id="+timberId+"&i_timbertype_id="+timberTypeId;;
...
{
	?>
	var fileCall='ajax_call.php?get=entryPointsEcoRSD&markId='+markDetailId+'&treeId='+treeId+"&i_timber_id="+timberId+"&i_timbertype_id="+timberTypeId;
...
if (window.XMLHttpRequest)
  ...
  var fileCall='ajax_call.php?get=timberListEconomicsRSD&markId='+markDetailId+'&treeId='+treeId;
 // alert(fileCall);
  xmlhttp.open("GET",fileCall,true);
  xmlhttp.send();
}
...
function populateTimberType(timberId,markDetailId,treeId)
{
	...
	if (window.XMLHttpRequest)
	  ...
	  var fileCall='ajax_call.php?get=timberTypeListEcoRSD&markId='+markDetailId+'&treeId='+treeId+"&i_timber_id="+timberId;
