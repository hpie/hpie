...
<tr>
 <td colspan="2">
  <a href='index.php?page=makeProgressEntryOpening&markId=<?php echo $markDetailId; ?>'>Add</a>
 </td>
</tr>
<?php 
...
<tr>
	...
	<td> 
	  <table>
	    <tr>
	      <td>
	        <a href='index.php?page=makeProgressEntryOpening&markId=<?php echo $detail['i_mark_id']; ?>&progressId=<?php echo $detail['id']; ?>'> Edit </a>
 	        </td>
	    </tr>
	  </table>
	</td>
