...
function validate_ftp_form(){
	...
	if(errorStatus){
		alert(strError);
		return false;
	}else if(ftp_option == '1'){
		var cfm = confirm("Are you sure you want to perform this action?\nWith this option you will overwrite your existing index.html file that on "+ftp_server);
		if(cfm){
			return true;
		}else{
			return false;
...
<tr class='titleBg'><td align='center' colspan='7' class='title'>Enter FTP Details</td></tr>	
...
<tr class='normal' onmouseover="this.className='active'" onmouseout="this.className='normal'">
	<td align ='right' width='25%' valign ='top'><input type ='radio' name ='ftp_option' id ='ftp_option' value ='1' onclick="showHideDiv(1)"></td>
	<td align ='left' valign ='top' class='small_text'>Option 1<br/> 
		The page will be installed in the following format "<b>www.yourdomain.com</b>"<font style ='color:red'> CAUTION</font> this means if you already have a website up it will erase it if thats the case then chooses option 2 or 3.
</td>
</tr>
<tr class='normal' onmouseover="this.className='active'" onmouseout="this.className='normal'">
	<td align ='right' valign ='top'><input type ='radio' name ='ftp_option' id ='ftp_option' value ='2' onclick="showHideDiv(2)"></td>
...
<td align ='left' valign ='top' class='small_text'>Option 3 <br/>Choose this option if you want your webinator pages stored into one folder. You will need to create a folder on your “hosting” server first (click here to see how) The page will be installed in the following format<b>"www.yourdomain.com/folder/yourwebinatorpage.html"</b>
	</td>
</tr>
<tr class='normal' onmouseover="this.className='active'" onmouseout="this.className='normal'">
...
<tr class='normal' onmouseover="this.className='active'" onmouseout="this.className='normal'">
	...
	<td align ='left' valign ='top'>
		...
		<input type ='hidden' name ='sqeeze_page_id' value ='<?=$sqeeze_page_id?>'>
