<%@ Page Title="" Language="C#" MasterPageFile="~/reports/Site.master" AutoEventWireup="true" CodeFile="batch_status.aspx.cs" Inherits="admin_batch_status" %>
    ...
    <tr>
        <td colspan="3">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    <asp:BoundField DataField="project" HeaderText="Project Code" 
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                ...
                SelectCommand="SELECT batch_status.code, batch_status.project_code, batch_status.center_code, batch_status.batch_no, batch_status.date, batch_status.s_date, batch_status.e_date, batch_status.course, course_detail.course_name, subject.sub, project_detail.project FROM batch_status INNER JOIN course_detail ON batch_status.course = course_detail.code INNER JOIN subject ON batch_status.sub = subject.code INNER JOIN project_detail ON batch_status.project_code = project_detail.code WHERE (batch_status.center_code = @center_code) AND (batch_status.project_code = @project_code) AND (batch_status.course = @course)">
                <SelectParameters>
