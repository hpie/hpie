<%@ Page Title="" Language="C#" MasterPageFile="~/user/Site.master" AutoEventWireup="true" CodeFile="Monthly_Stipend.aspx.cs" Inherits="user_Monthly_Stipend" %>
        ...
        <ItemTemplate>
             <%#Container.DataItemIndex+1 %>
                    ...
                    <asp:TemplateField HeaderText="Monthly Stipend">
                        <ItemTemplate>
                            <asp:Label ID="month_stip" runat="server">1000</asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                  ...
                  <%--  <asp:TemplateField HeaderText="Absent">
                    ...
                    <asp:TemplateField HeaderText="Total Stipend">
                        <ItemTemplate>
                            <asp:Label ID="tot_stip" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Check if you want paid">
                        <ItemTemplate>
