<%@ Page Title="" Language="C#" MasterPageFile="~/user/Site.master" AutoEventWireup="true" CodeFile="profile.aspx.cs" Inherits="user_profile" %>
        ...
        <ItemTemplate>
            ...
            &nbsp;&nbsp;<br />---------------------------------------------------------------<br />
                ...
                <asp:DataList ID="DataList3" runat="server" DataSourceID="SqlDataSource4" 
                    ...
                    oncancelcommand="DataList3_CancelCommand">
                    <EditItemTemplate>
                        <table class="style10">
                            <tr>
                                <td class="style11">
                            ...
                            <tr>
                                <td>
                                    Bank Name</td>
                                <td>
                                    <asp:DropDownList ID="bank_name" runat="server" datasourceid="SqlDataSource5" 
...
<br />
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                    ...
                    UpdateCommand="UPDATE tb4 SET ac_no =@ac_no, bank_name =@bank_name, ifsc =@ifsc, branch =@branch where center_code=@center_code">
                    <SelectParameters>
                        <asp:SessionParameter DefaultValue="" Name="center_code" SessionField="start_a" 
                            Type="String" />
                    </SelectParameters>
                    <UpdateParameters>
