<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trai_not.aspx.cs" Inherits="admin_trai_not" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [s_name], [s_f_name], [social_status], [center_code], [s_id_main], [tr_date] FROM [student_detail] WHERE ([tr_status] = @tr_status) AND ([project_code] = @project_code) order by center_code, s_id">
            <SelectParameters>
                <asp:Parameter DefaultValue="Not Active" Name="tr_status" Type="String" />
