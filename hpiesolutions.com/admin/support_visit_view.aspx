<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.master" AutoEventWireup="true" CodeFile="support_visit_view.aspx.cs" Inherits="user_support_visit_view" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <link href="../Styles/PrintStyle.css" rel="stylesheet" type="text/css" />
</asp:Content>
...
<p class="MsoNormal">
    ...
    <table border="1px" cellspacing="0" cellpadding="2"cellspacing="0" class="style24">
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList4" runat="server" 
                    ...
                    DataValueField="center_code_main" AutoPostBack="True" 
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM dbo.support_visit where center_code=@center_code and visit_date=@visit_date">
                    <DeleteParameters>
                        <asp:ControlParameter ControlID="DropDownList4" Name="center_code" 
                            PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="DropDownList1" Name="visit_date" 
                            PropertyName="SelectedValue" />
                    </DeleteParameters>
                    <SelectParameters>
        ...
        <tr>
            <td class="style25">
                 <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click1">Search</asp:LinkButton>
             &nbsp;|
