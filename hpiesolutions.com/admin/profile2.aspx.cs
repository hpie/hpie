...
public partial class profile2 : System.Web.UI.Page
{
    ...
    {
        //if (Request.QueryString["cd"].ToString() == "")
        //{
        //    Label111.Text = "blank";
        //}
        //else
        //{
        //    Label111.Text = Request.QueryString["cd"].ToString();
        //}
    }
    ...
    protected void DataList1_UpdateCommand(object source, DataListCommandEventArgs e)
    {
        ...
        SqlDataSource1.UpdateParameters["std"].DefaultValue = std;
    ...
    protected void DataList3_UpdateCommand(object source, DataListCommandEventArgs e)
    {
        ...
        SqlDataSource4.UpdateParameters["bank_name"].DefaultValue = ((DropDownList)(e.Item.FindControl("bank_name"))).Text;
        ...
        SqlDataSource4.UpdateParameters["pan_no"].DefaultValue = ((TextBox)(e.Item.FindControl("pan_no"))).Text;
