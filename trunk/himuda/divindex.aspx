<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"  CodeFile="divindex.aspx.cs" Inherits="_Default" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:TemplateField HeaderText="Sr.No">
                    <ItemTemplate>
                        <asp:Label ID="Label3" runat="server" Text="<%# r2 %>"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Sub. During the year+Arear">
                    <FooterTemplate>
                ...
                <asp:TemplateField HeaderText="Adjustments/Final Payment">
                    <FooterTemplate>
                ...
                <asp:TemplateField HeaderText="Adjustment/Final Payment">
                    <FooterTemplate>
                ...
                <asp:TemplateField HeaderText="Adjustment/Final Payment" Visible="False">
                    <FooterTemplate>
