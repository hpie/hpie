	...
	<div id="content-wrap"><div id="content">		
		...
		<div id="main">		
			...
			<div class="post">
				...
				<h1><div style="float:left">Create the lot for the Verified List [1]</div>
...
?></font></div></h1>
			 	<br>
				<form  method="post" enctype="multipart/form-data" name="form1" onsubmit="return check();" action="blaze_detail.php">
					<p>Select Year for which verified list is to be created <select name="year" >
 ...
 <?php 
	// Connects to your Database
			...
			$data = mysql_query("SELECT distinct lotno FROM lot_desc order by lotno") or die("No table"); 
