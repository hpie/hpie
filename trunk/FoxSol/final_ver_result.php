...
<h1>
<div style="float: left">Verified List</div>
...
{
	$currentlot=addslashes($data['lotno']);
	
	$q="select * from lot_desc where lotno='".$currentlot."'";
...
<input type=submit value='Print the List'
	style="background-color: #b6e38e; width: 130px;"
	onclick="window.open('print.php','my','scrollbars=yes')">
