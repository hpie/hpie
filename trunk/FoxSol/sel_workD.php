	...
	<div id="content-wrap"><div id="content">		
		...
		<div id="main">		
			...
			<div class="post">
				...
				<h1><div style="float:left">Deallocate Work to LSM</div>
...
?></font></div></h1>
			 	<br>
				<form  method="post" enctype="multipart/form-data" name="form1" onsubmit="return check();" action="enter_workdetailsD.php">
