...
<table border=0>
	<tr>
		...
		<td><input type="text" name="tenblazed"
			value="<?php echo $tenblazes; ?>" disabled="disabled" /></input></td>
	</tr>


	<tr>
		<td>Yield Fixed</td>
		<td><input type="text" name="YieldFixed"
			value="<?php echo $yiefixed ;?>" disabled="disabled" /></input></td>
	</tr>
	<tr>
		<td>Total resin to be extracted in Qtls</td>
		<td><input type="text" name="TotalResin"
			value="<?php echo $totres; ?>" disabled="disabled" /></input></td>
	</tr>
	<tr>
		<td>Proposed Carriage Upset Price</td>
		<td><input type="text" value="<?php echo $avgrate ;?>" /></td>
	</tr>
	<tr>
		<td>Proposed Tranportation Upset Price</td>
		<td><input type="text" value="<?php echo $tchargeavg ;?>" /></td>
	</tr>
</table>
...
<input type="hidden" name="leadManQ"
	value="<?php  echo implode($leadManQ,",") ;?>" />
<input type="hidden" name="leadMulQ"
	value="<?php echo implode($leadMulQ,",");?>" />
<input type="hidden" name="leadManD"
	value="<?php  echo implode($leadManD,",") ;?>" />
<input type="hidden" name="leadMulD"
	value="<?php echo implode($leadMulD,",");?>" />
<input type="hidden" name="leadtracQ"
	value="<?php echo implode($leadtracQ,",");?>" />
<input type="hidden" name="leadtracD"
	value="<?php echo implode($leadtracD,",");?>" />
...
<input type="hidden" value="<?php echo $distancefact ;?>"
	name="distancefact" />
<input type="hidden" value="<?php echo $lrate50 ;?>" name="lrate50" />
<input type="hidden" value="<?php echo $lrateb50 ;?>" name="lrateb50" />
<input type="hidden" value="<?php echo $distanceload ;?>"
	name="distanceload" />
<input type="hidden" value="<?php echo $tchargeavg ;?>"
	name="tchargeavg" />
...
<input type="submit" value="Save and Show Economics" />
<br />
