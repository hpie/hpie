	...
	<div id="content-wrap"><div id="content">		
		...
		<div id="main">		
			...
			<div class="post">
				...
				<h1><div style="float:left">Show Verified List</div>
...
?></font></div></h1>
			 	<br>
				<form  method="post" enctype="multipart/form-data" name="form1" onsubmit="return check();" action="print.php">
 ...
 <?php 
	 //TODO:Sunil $data = mysql_query("SELECT distinct division FROM verify") or die("No table");
