	...
	if(isset($_POST['submitted']))
	{
		...
		}else if($action=='setExpenditureOnWork')
		{
			if($_POST['rowid']=="0")
			{
				...
				$db->query("INSERT INTO t_expenditure_on_work (id, rate_calculation_for_lot_id, division_code, unit_code, lot_no, forest_code, zone_code, eow_code, exp_eow, blazes_received, yield_fixed, cost_crop_setting, exp_crop_setting, cost_extr, turnout, exp_extr_turnout, total_tins, distance_to_rsd, cost_tpt_tins_to_forest, exp_tpt_tins_to_forest, cost_tpt_tins_to_rsd, exp_tpt_tins_to_rsd, cost_tpt_drums_to_forest, exp_tpt_drums_to_forest, cost_tpt_drums_to_rsd, exp_tpt_drums_to_rsd, cost_carriage_mule_rsd, dist_carriage_mule_rsd, exp_carriage_mule_rsd, cost_carriage_manual_rsd, dist_carriage_manual_rsd, exp_carriage_manual_rsd, cost_carriage_tractor_rsd, dist_carriage_tractor_rsd, exp_carriage_tractor_rsd, cost_carriage_other_rsd, dist_carriage_other_rsd, exp_carriage_other_rsd, cost_soldering_of_resin, exp_soldering_of_resin, cost_mate_commission, exp_mate_commission, season_year, created_by)
          			VALUES (NULL, '".$_POST['rate_calculation_for_lot_id']."', '".$_POST['division_code']."', '".$_POST['unit_code']."', '".$_POST['lot_no']."', '".$_POST['forest_code']."', '".$_POST['zone_code']."', '".$_POST['eow_code']."', '".$exp_eow."', '".$_POST['blazes_received']."', '".$_POST['yield_fixed']."', '".$_POST['cost_crop_setting']."', '".$_POST['exp_crop_setting']."', '".$_POST['cost_extr']."', '".$_POST['turnout']."', '".$_POST['exp_extr_turnout']."', '".$_POST['total_tins']."', '".$_POST['distance_to_rsd']."', '".$_POST['cost_tpt_tins_to_forest']."', '".$_POST['exp_tpt_tins_to_forest']."', '".$_POST['cost_tpt_tins_to_rsd']."', '".$_POST['exp_tpt_tins_to_rsd']."', '".$_POST['cost_tpt_drums_to_forest']."', '".$_POST['exp_tpt_drums_to_forest']."', '".$_POST['cost_tpt_drums_to_rsd']."', '".$_POST['exp_tpt_drums_to_rsd']."', '".$_POST['cost_carriage_mule_rsd']."', '".$_POST['dist_carriage_mule_rsd']."', '".$_POST['exp_carriage_mule_rsd']."', '".$_POST['cost_carriage_manual_rsd']."', '".$_POST['dist_carriage_manual_rsd']."', '".$_POST['exp_carriage_manual_rsd']."', '".$_POST['cost_carriage_tractor_rsd']."', '".$_POST['dist_carriage_tractor_rsd']."', '".$_POST['exp_carriage_tractor_rsd']."', '".$_POST['cost_carriage_other_rsd']."', '".$_POST['dist_carriage_other_rsd']."', '".$_POST['exp_carriage_other_rsd']."', '".$_POST['cost_soldering_of_resin']."', '".$_POST['exp_soldering_of_resin']."', '".$_POST['cost_mate_commission']."', '".$_POST['exp_mate_commission']."', '".$_POST['season_year']."', '".$_POST['created_by']."' )");
              		...
              		<fieldset>
						<legend><font size=5 color=#72A545>Upset Price for Lot of Season <?php echo $season_year; ?></font></legend><br />
							...
							<table style="position:relative" border="1">
								...
								<tr>    
									<td>Forest</td> <td>RSD</td> <td>No of Blazes</td> <td>Proposed Yield</td> <td>Turn Out</td>
                                </tr>
                                	<?php
                                		$index=0; 
										...
										foreach ( $tappings as $tapping )
				         				{ 
								         	...
								         	$forestRsds = $db->get_results("SELECT forest_rsd_name, forest_rsd_distance FROM m_forest f, m_forest_rsd r WHERE f.forest_code=r.forest_code",ARRAY_A); 
								         	echo(" <td>");
