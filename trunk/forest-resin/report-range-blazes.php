<?php
	...
	//include config
	include "config.php";
	$titleMsg="Blazes-Taken-Over-Report";
	...
	<!-- content starts here -->		    	
        ...
        <!-- post starts here -->				            
            <div class="post">
                ...
                <br />
                	<form action="report-range-blazes.php" method="post" name="blazesReportForm" id="blazesReportForm"> 
				 ...
				 ?>
				 	...
				 	<div>
              		...
              		<div class="donotprint">
              			<br /><br />
              			<form action="report-range-blazes.php" method="post" name="reportForm" id="reportForm">
