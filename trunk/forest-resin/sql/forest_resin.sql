...
CREATE TABLE IF NOT EXISTS `t_expenditure_on_work` (
  ...
  `turnout_carriage_mule_rsd` float (10,3)  NOT NULL DEFAULT '0' COMMENT  'Resin in quintal transported by mule',
  ...
  `turnout_carriage_manual_rsd` float (10,3)  NOT NULL DEFAULT '0' COMMENT  'Resin in quintal transported by manual',
  ...
  `turnout_carriage_tractor_rsd` float (10,3)  NOT NULL DEFAULT '0' COMMENT  'Resin in quintal transported by tractor',
  ...
  `turnout_carriage_other_rsd` float (10,3)  NOT NULL DEFAULT '0' COMMENT  'Resin in quintal transported by other',
