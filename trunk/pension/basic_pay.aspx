<%@ Page Language="C#"  EnableEventValidation="true" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="basic_pay.aspx.cs" Inherits="basic_pay" Title="Untitled Page" %>
        ...
        <tr>
            <td class="style3" colspan="2">
                ...
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" 
                    ShowFooter="True"  onrowcommand="GridView1_RowCommand" onrowdatabound="GridView1_RowDataBound" >
                  <Columns>
