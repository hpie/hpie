<%@ Page Language="C#" AutoEventWireup="true" CodeFile="basic_view.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="Joining_view" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="Content">
        ...
        <asp:Panel ID="Panel1" runat="server" Height="400px" 
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                  <asp:TemplateField HeaderText="Srno"><ItemTemplate>
                    ...
                    <asp:BoundField ConvertEmptyStringToNull="False" DataField="cps" 
                        HeaderText="CPS No" SortExpression="cps" />
                    ...
                    <asp:BoundField DataField="ps_type" HeaderText="PS Type" 
                        SortExpression="ps_type" />
                    <asp:BoundField DataField="ps_area" HeaderText="PS Area" 
                        SortExpression="ps_area" />
                    <asp:BoundField DataField="ps_Group" HeaderText="PS Group " 
                        SortExpression="ps_Group" />
                    <asp:BoundField DataField="PS_Level" HeaderText="PS Level" 
                        SortExpression="PS_Level" />
                    <asp:BoundField DataField="Wage_Type" HeaderText="Wage Type" 
                        SortExpression="Wage_Type" />
            ...
            SelectCommand="SELECT Joining.First, Joining.Last, Joining.Panno, Joining.BirthDate, Joining.GPF, basic_pat.PPO, basic_pat.CPS, basic_pat.Start_date, basic_pat.End_date, basic_pat.PS_Type, basic_pat.PS_area, basic_pat.PS_Group, basic_pat.PS_Level, basic_pat.Wage_type, basic_pat.Amount FROM Joining INNER JOIN basic_pat ON Joining.Ppno = basic_pat.PPO where basic_pat.User1=@User1  order by basic_pat.PPO">
                <SelectParameters>
