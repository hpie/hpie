    ...
    <table cellpadding="0" cellspacing="0" class="style4">
        ...
        <tr>
            ...
            <td class="style32">
                ...
                <asp:Button ID="Button3" runat="server" onclick="Button3_Click" 
                    style="font-size: xx-small" Text="Search" Width="42px" />
        ...
        <tr>
            <td class="style20" colspan="4">
                    ...
                    DataKeyNames="code" CssClass="style28" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="TPB/PGI">
                                    <FooterTemplate>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("type") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
        ...
        <tr>
            ...
            <td class="style5">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    InsertCommand="INSERT INTO fc13(fac_ord_no, pri_no, your_o_no, dt, ms, pro_size, qty,wtqtl,wtkg, rate, remark, desti, consi,type) VALUES (@fac_ord_no, @pri_no, @your_o_no, @dt, @ms, @pro_size, @qty,@wtqtl,@wtkg, @rate, @remark, @desti, @consi,@type)" 
                    DeleteCommand="DELETE FROM fc13 WHERE (code = @code)" 
                    UpdateCommand="UPDATE fc13 SET rate = @rate WHERE (code = @code)">
                    <DeleteParameters>
