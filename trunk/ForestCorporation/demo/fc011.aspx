<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="fc011.aspx.cs" Inherits="fc011" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" BackColor="White" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Rosin 'B' Grade">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="T. Oil">
             <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Bitumen">
             <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Lime">
            ...
            <asp:TemplateField HeaderText="Black Lamp">
             <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Steam Coal/Fuel Wood">
             <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Daily Production">
             <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Progressive Total">
             <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Sign of Subsidiary Section Incharge">
             <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Sign of FM/GM">
             <EditItemTemplate>
