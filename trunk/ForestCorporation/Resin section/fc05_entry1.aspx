    ...
    <br />
            ...
            <td class="style7" __designer:mapid="38f">
                ...
                <tr __designer:mapid="3b3">
                    ...
                    <td class="style7" __designer:mapid="3b6">
                        <asp:TextBox ID="tins_drums" runat="server">0</asp:TextBox>
        ...
        <tr __designer:mapid="3b9">
            ...
            <td class="style7" __designer:mapid="3bb">
                <asp:TextBox ID="net_wt_sakki" runat="server">0</asp:TextBox>
            </td>
        </tr>
                ...
                <tr __designer:mapid="3c1">
                    ...
                    <td class="style10" __designer:mapid="3c3">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                            ...
                            UpdateCommand="UPDATE fc05 SET stype =@stype, notin =@notin, netsakki =@netsakki, rem =@rem where reqslipno=@reqslipno">
                            <UpdateParameters>
