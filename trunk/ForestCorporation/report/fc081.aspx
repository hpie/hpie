<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="fc081.aspx.cs" Inherits="fc08" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    onrowdatabound="GridView1_RowDataBound">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="2">
                <FooterTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="4.3">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox7" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="5">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox8" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="8">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox11" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="9">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox12" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="12.1">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox15" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="12.2">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox16" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="13">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox17" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="14">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox18" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="18.2.2">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox24" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="20">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox26" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="22">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox28" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="23.1">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox29" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="23.2">
              <FooterTemplate>
                    <asp:TextBox ID="TextBox30" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="25.1">
             <FooterTemplate>
                    <asp:TextBox ID="TextBox32" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="25.2">
             <FooterTemplate>
                    <asp:TextBox ID="TextBox33" runat="server" Width="68px"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [fc08]" 
        InsertCommand="INSERT INTO fc08(dt, shift, steam_p_time, steam_p_press, resin_con_time, resin_con_kgs, resin_con_nooftins, at_what_5, times_6, putting_7, how_many_8, how_much_9, how_much_10, at_what_11, dirty_vatno, dirty_barrel, vat_no_13, charge_no_14, at_what_15, at_what_16, how_murch_17, rosin_pro_18_1, weight_qtl, weight_kgs, rosin_grade, tur_20, tank_21, how_many_22, sakki_found_qlts, sakki_found_kgs, name_of_24, how_much_qlts, how_much_kgs, remarks) VALUES (@dt, @shift, @steam_p_time, @steam_p_press, @resin_con_time, @resin_con_kgs, @resin_con_nooftins, @at_what_5, @times_6, @putting_7, @how_many_8, @how_much_9, @how_much_10, @at_what_11, @dirty_vatno, @dirty_barrel, @vat_no_13, @charge_no_14, @at_what_15, @at_what_16, @how_murch_17, @rosin_pro_18_1, @weight_qtl, @weight_kgs, @rosin_grade, @tur_20, @tank_21, @how_many_22, @sakki_found_qlts, @sakki_found_kgs, @name_of_24, @how_much_qlts, @how_much_kgs, @remarks)">
        <InsertParameters>
