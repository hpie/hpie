...
namespace Disk_Cleaner
{
    public partial class Updater : Form
    {
        ...
        {
            get {
                long o = Properties.Settings.Default.lastUpdateDate;
                if (o != 0)
                    return DateTime.FromBinary(o);
                else
                    return DateTime.MinValue;
            }
            set { Properties.Settings.Default.lastUpdateDate = value.ToBinary(); }
        }
        ...
        protected override void OnShown(EventArgs e)
        {
            ...
            if (FindUpdate(ref strVersion, ref strReleaseDate, ref strChangeLogURL, ref strDownloadURL, false))
            {
                ...
                this.labelInfo.Text = "A newer version is available";
            }
            else
            {
        ...
        public static bool FindUpdate(ref string strVersion, ref string strReleaseDate, ref string strChangeLogURL, ref string strDownloadURL, bool bCheckDate = true)
        {
            bool bRet = false;
            ...
            try
            {
                XmlReader xmlReader = XmlTextReader.Create(Properties.Settings.Default.updateURI);
