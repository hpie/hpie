   ...
   <div id="div_print">  
    ...
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT * FROM [sale_depo] WHERE (CONVERT (datetime, date, 101) BETWEEN @first AND @second) and name_div=@div">
            <SelectParameters>
                <asp:QueryStringParameter Name="first" QueryStringField="first" />
                <asp:QueryStringParameter Name="second" QueryStringField="second" />
                <asp:QueryStringParameter Name="div" QueryStringField="div" />
            </SelectParameters>
        </asp:SqlDataSource>
    </p>
    <p>
