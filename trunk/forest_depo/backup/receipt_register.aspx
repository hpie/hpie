...
<%--
    ...
    <p>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM dbo.tally_sheet where division=@division and (CONVERT (datetime, date_of_rec, 101) BETWEEN @first AND @second) order by challan_no, size_type">
            <SelectParameters>
