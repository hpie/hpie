        ...
        Label1.Text = "";
         ...
         if (dv.Table.Rows.Count == 0)
         {
             ...
             for (i = 0; i < GridView1.Rows.Count; i++)
             {
                 ...
                 SqlDataSource1.InsertParameters["sale_bid_amt"].DefaultValue = sale_bid_amt;
                 ...
                 SqlDataSource1.InsertParameters["amt"].DefaultValue = amt;
                 SqlDataSource1.InsertParameters["var_amt"].DefaultValue = var_amt;
                 SqlDataSource1.InsertParameters["var_percent"].DefaultValue = var_per;
