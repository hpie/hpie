...
public partial class statement_timber_rec : System.Web.UI.Page
{
    Int32 sr = 1, sr2 = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Session["division"] = "0".ToString();
            Session["truck_no"]="0".ToString();
            //Session["spec"] = "nl";
            Session["chl2"] = "nl2";
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            string division, truck_no;           
            ((Label)(e.Row.FindControl("sr"))).Text = sr.ToString();
            division = ((Label)(e.Row.FindControl("division"))).Text;
            truck_no = ((Label)(e.Row.FindControl("truck_no"))).Text;
           
            string tt1 = Session["division"].ToString();
            string tt2 = Session["truck_no"].ToString();
            ...
            Session["truck_no"] = truck_no;
            string specc;
            specc = ((Label)(e.Row.FindControl("specc"))).Text;
            string qry2 = "SELECT division, truck_no, spec, sum(size) as size, sum(size_vol) as size_vol FROM tally_sheet_chl WHERE (division = '" + division + "') AND (truck_no ='" + truck_no + "') AND(spec='"+specc+"') and (CONVERT(datetime, date_of_rec, 101) BETWEEN '" + TextBox1.Text + "' AND '" + TextBox2.Text + "') group by division, truck_no, spec order by division";
