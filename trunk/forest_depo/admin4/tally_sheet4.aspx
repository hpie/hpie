...
<br />
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ControlToValidate="date_of_auction" ErrorMessage="Enter Auction Date !" 
        ForeColor="#CC3300" SetFocusOnError="True"></asp:RequiredFieldValidator>
    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    Enter Auction Date:
                <asp:TextBox ID="date_of_auction" runat="server"></asp:TextBox>
                <asp:CalendarExtender ID="date_of_auction_CalendarExtender" runat="server" 
                    Enabled="True" TargetControlID="date_of_auction">
 ...
 <%--           <asp:TemplateField HeaderText="No (as per receipt)">
           ...
           <%-- <asp:TemplateField HeaderText="No (As per challan)">
            ...
            <asp:TemplateField HeaderText="Date of Auction">
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("auction_date","{0:d}") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        UpdateCommand="UPDATE dbo.tally_sheet SET mark_to_auction =@mark_to_auction, auction_date=@auction_date where code=@code">
        <DeleteParameters>
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="code" />
            <asp:ControlParameter ControlID="date_of_auction" Name="auction_date" 
                PropertyName="Text" />
        </UpdateParameters>
    </asp:SqlDataSource>
            </asp:Content>
