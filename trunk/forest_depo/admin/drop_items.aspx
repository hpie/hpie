        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    InsertCommand="INSERT INTO dbo.spec(spec, categ) VALUES (@spec, @categ)" 
                    ...
                    <InsertParameters>
                        ...
                        <asp:ControlParameter ControlID="DropDownList1" Name="categ" 
                            PropertyName="SelectedValue" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:ControlParameter ControlID="spec_t" Name="spec" PropertyName="Text" />
...
&nbsp;
        ...
        <tr>
            ...
            <td style="margin-left: 40px">
                &nbsp;</td>
            <td style="margin-left: 40px" rowspan="5">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="code" DataSourceID="SqlDataSource5" 
                    onrowdeleting="GridView1_RowDeleting">
                    <Columns>
                        <asp:BoundField DataField="factor" HeaderText="Factor" 
                            SortExpression="factor" />
                        <asp:BoundField DataField="val" HeaderText="Value" SortExpression="val" />
                        <asp:CommandField ShowDeleteButton="True" />
                    </Columns>
                </asp:GridView>
                <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:forest_depoConnectionString %>" 
                    DeleteCommand="delete from factor where code=@code" 
                    SelectCommand="SELECT * FROM [factor]">
                    <DeleteParameters>
        ...
        <tr>
            <td>
                Factor Name</td>
            <td style="margin-left: 40px">
                <asp:TextBox ID="factor_name" runat="server" ValidationGroup="fg"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                    ControlToValidate="factor_name" ErrorMessage="Enter Factor Name !" ForeColor="#CC3300" 
                    ValidationGroup="fg" SetFocusOnError="True"></asp:RequiredFieldValidator>
            &nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td style="margin-left: 40px" class="style5">
                <asp:TextBox ID="factor_val" runat="server" ValidationGroup="fg"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                    ControlToValidate="factor_val" ErrorMessage="Enter Factor Value !" ForeColor="#CC3300" 
                    ValidationGroup="fg" SetFocusOnError="True"></asp:RequiredFieldValidator>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="margin-left: 40px">
                <asp:LinkButton ID="LinkButton12" runat="server" onclick="LinkButton12_Click" 
                    ValidationGroup="fg">Insert</asp:LinkButton>
&nbsp;<asp:Label ID="Label1" runat="server"></asp:Label>
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td style="margin-left: 40px">
                <asp:SqlDataSource ID="SqlDataSource_factor" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:forest_depoConnectionString %>" 
                    InsertCommand="INSERT INTO dbo.factor(factor, val) VALUES (@factor, @val)" 
                    SelectCommand="SELECT * from factor where factor=@factor">
                    <InsertParameters>
                        <asp:ControlParameter ControlID="factor_name" Name="factor" 
                            PropertyName="Text" />
                        <asp:ControlParameter ControlID="factor_val" Name="val" PropertyName="Text" />
                    </InsertParameters>
                    <SelectParameters>
                        <asp:ControlParameter ControlID="factor_name" Name="factor" 
                            PropertyName="Text" />
