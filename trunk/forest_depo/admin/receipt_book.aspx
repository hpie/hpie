...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                     ErrorMessage="Enter Payment No !" ForeColor="#CC3300" 
                     ControlToValidate="cdr_no" SetFocusOnError="True"></asp:RequiredFieldValidator>
             </td>
         </tr>
         <tr>
             <td>
             ...
             &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                     ErrorMessage="Enter Date !" ForeColor="#CC3300" ControlToValidate="dat" 
                     SetFocusOnError="True"></asp:RequiredFieldValidator>
                 <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                     ControlToValidate="dat" ErrorMessage="Enter Valid Date !" ForeColor="#CC3300" 
         ...
         <tr>
             ...
             &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                     ErrorMessage="Enter Payable At !" ForeColor="#CC3300" 
                     ControlToValidate="payable_at" SetFocusOnError="True"></asp:RequiredFieldValidator>
             </td>
         </tr>
         <tr>
             <td>
