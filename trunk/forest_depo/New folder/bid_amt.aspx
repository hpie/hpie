<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="bid_amt.aspx.cs" Inherits="bid_amt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList3" runat="server" 
                    DataSourceID="SqlDataSource_pur" DataTextField="name_purchaser" 
                    DataValueField="name_purchaser">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
    ...
    UpdateCommand="UPDATE dbo.tally_sheet SET name_purchaser =@name_purchaser, bid_amt=@bid_amt, bid_avg=@bid_avg where auction_date=@auction_date and hsd_lot_no=@hsd_lot_no">
        <UpdateParameters>
            <asp:ControlParameter ControlID="DropDownList3" Name="name_purchaser" 
