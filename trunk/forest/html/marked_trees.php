...
<tr>
	...
	<table width='100%' cellpadding="0px" cellspacing="0px">
		<tr>
			<td valign="top"><a
				href='index.php?page=editTreeDetail&markid=<?php echo $markDetailId;?>&treeid=<?php echo $tree ;?>' title="Edit the Marking and Royality details.">Edit</a>
			</td>
			<td><a href="javascript:confirmDelete('index.php?page=deleteTreeDetail&markid=
