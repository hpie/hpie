...
<table width='100%' align='center' cellpadding='2' cellspacing='2' border='0'>
		<tr>
			...
			<tr class='titleBg'>
				<td align='center' colspan='8' class='title'>Overhead Entity Management&nbsp;:&nbsp;(<?=$totalRecords;?>)</td>
			</tr>
			<?
			...
			<tr class='title1Bg'>
				...
				<td class='title1' align='left'><a href="<?=BASE_URL.ADMIN_DIR;?>/overhead_entities.php?ob=overEntity&o=<?=$oorderlink?>" title="Sort by department id">Overhead Entity Name</a></td>
				<td class='title1' align='left'><a href="<?=BASE_URL.ADMIN_DIR;?>/overhead_entities.php?ob=forest&o=<?=$oorderlink?>" title="Sort by department id">Forest Name</a></td>
				<td class='title1' align='left'>DFO Name</td>
		...
		?>
			<tr class='normal' onmouseover="this.className='active'" onmouseout="this.className='normal'">
				...
				href='add_overhead_entity.php?id=<?=$id;?>'>Edit</a>&nbsp|&nbsp;
				<a  class='delete' title ='delete <?=$vc_name;?>'onClick = 'deleteRecord("<?=$id;?>","<?=$vc_name;?>","overhead_entity")'>Delete</a></td>
