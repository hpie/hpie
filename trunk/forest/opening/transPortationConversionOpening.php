...
if($progressId != '' )
{
	...
	$transPortationDetail=$markDetail->getprogressTransportationDetailCompleteOpening($progressId);
		...
		<table style="width: 40%">
			<tr>
				<td><input type="button" name="Cancel" id="Cancel" value="Cancel"
					onclick="javascript:parent.location='index.php?page=transportationHomeOpening&markId=<?php echo $markDetailId;?>'" /></td>
				<td colspan="2" align="right"><input type="button" name="Cancel" id="Cancel" value="Add More"
					onclick="javascript:parent.location='index.php?page=transportationEntryNewOpening&progressId=<?php echo $progressId;?>&markId=<?php echo $markDetailId;?>'" /></td>
			</tr>
		</table>
		</td>
	</tr>
