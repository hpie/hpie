	...
	<tr>
		...
		<table cellpadding="5px" cellspacing="5px"
			...
			<tr>
				...
				<td><?php 
				echo makeTimberlist($arrAllTimberType,"i_timber_id_[".$k->id."][".$existingCount."]",$timberStoredType,"selectValuesIndex(\"timberDetailTable_".$count."\",\"i_timber_id_[".$k->id."][".$existingCount."]\",\"i_tree_id[<?php echo $k->id;?>][<?php echo $existingCount;?>]\")",".$existingCount.","");
				?></td>
				<td><input
