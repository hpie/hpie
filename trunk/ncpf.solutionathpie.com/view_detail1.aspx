<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="view_detail1.aspx.cs" Inherits="detail" Title="Untitled Page" %>
<%@ Register
 ...
 <table cellpadding="0" cellspacing="0" BORDER="1"
        ...
        <tr class="style25">
            <td class="style32">
                    ...
                    <br />
                    Designation:-<asp:Label ID="Label193" runat="server" Text="Label"></asp:Label>
...
Rate of Interest =8%
        ...
        <tr>
            <td class="style32">
                    ...
                    <asp:Label ID="Label24" runat="server" CssClass="style29" Text="31 March"></asp:Label>
