...
public partial class user_monthly_atten : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        if (course.SelectedItem.Text == "ALL")
        {
            ...
            SqlDataSource3.SelectCommand = "SELECT * FROM [monthly_atten] WHERE Date between @first and @second and center_code=@code order by course";
        ...
        else
        {
            ...
            SqlDataSource3.SelectParameters["first"].DefaultValue = dd.ToString();
            SqlDataSource3.SelectParameters["second"].DefaultValue = dd2.ToString();
            SqlDataSource3.SelectCommand = "SELECT * FROM [monthly_atten] WHERE Date between @first and @second and course=@course and center_code=@code order by course";
            GridView1.DataSource = SqlDataSource3;            
            GridView1.DataBind();          
        }
