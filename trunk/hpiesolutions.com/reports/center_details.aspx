<%@ Page Title="" Language="C#" MasterPageFile="~/reports/Site.master" AutoEventWireup="true" CodeFile="center_details.aspx.cs" Inherits="admin_center_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataSourceID="SqlDataSource1" Width="885px" 
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
        DataSourceID="SqlDataSource1" Visible="False" Width="910px">
        <Columns>
            <asp:BoundField DataField="center_code_main" HeaderText="Center Code" 
                SortExpression="center_code_main" />
            <asp:BoundField DataField="name" HeaderText="Name" SortExpression="name" />
            ...
            <asp:BoundField DataField="name1" HeaderText="Contact person name" 
                SortExpression="name1" />
            <asp:BoundField DataField="job_title" HeaderText="C. Job Title" 
                SortExpression="job_title" />
            <asp:BoundField DataField="Email1" HeaderText="C. Email" 
