<%@ Page Title="" Language="C#" MasterPageFile="~/reports/Site.master" AutoEventWireup="true" CodeFile="support_visit_view.aspx.cs" Inherits="user_support_visit_view" %>
...
<p class="MsoNormal">
    ...
    <table class="style24">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT* FROM support_visit where center_code=@center_code order by visit_date desc">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownList2" Name="center_code" 
        ...
        <tr>
            <td class="style25">
                <asp:Button ID="btnPrint" runat="server" Text="Print" OnClientClick = "return PrintPanel();" /></td>
            <td>
                &nbsp;</td>
        </tr>
    </table>
...
<p class="MsoNormal">
    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource2">
        <ItemTemplate>
            <table border="1px" cellspacing="0" cellpadding="2"cellspacing="0" cellpadding="2" class="style1">
                <tr>
                    <td class="style27">
                        Project Code</td>
                    <td>
            ...
            <table border="1px" cellspacing="0" cellpadding="2"class="style1">
                <tr>
                    <td class="style23">
                        <span style="mso-bidi-font-weight: normal"><span class="style8" 
            ...
            <p class="MsoNormal" style="line-height: 150%">
                ...
                <p align="center" class="MsoNormal" 
                    ...
                    <table border="1px" cellspacing="0" cellpadding="2"class="style9">
                        <tr>
                    ...
                    <p class="MsoNormal" style="line-height: 150%">
                        ...
                        ________________________________________________________________________________________________</span><p 
                            ...
                            Placement</span></b>
                            <table border="1px" cellspacing="0" cellpadding="2"class="style14">
                                <tr>
