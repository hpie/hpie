...
public partial class user_monthly_atten : System.Web.UI.Page
{
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        if (GridView1.Rows.Count != 0)
        {
            try
            {
                ...
                exl.exporttoexcel("Center_details.xls", GridView1);
            }
            catch (Exception ex)
            {
            }
        ...
        //    Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "Monthly_Attendence_Details.xls"));
    ...
    {
        SqlDataSource7.DeleteParameters["code"].DefaultValue = GridView1.DataKeys[e.RowIndex].Value.ToString();
